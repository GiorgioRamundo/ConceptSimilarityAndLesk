...
public class Examples {
    ...
    public Examples(Dictionary dictionary) throws JWNLException {
        ...
        TABLE = dictionary.lookupIndexWord(POS.NOUN,"table");
        System.out.println(TABLE.getSenses().get(0).getGloss());
    }

    public void go() throws JWNLException, CloneNotSupportedException {
        demonstrateMorphologicalAnalysis(MORPH_PHRASE);
        demonstrateListOperation(TABLE);
    ...
    public static void main2(String[] args) throws JWNLException {
        ...
        String w = "dog";
        IndexWord word = d.lookupIndexWord(POS.NOUN,w);
        PointerTargetTree hypernymsTree = PointerUtils.getHypernymTree(word.getSenses().get(0));
        System.out.println(hypernymsTree.toList().get(0).size());
        //hypernymsTree.print();
    }
    ...
    private void demonstrateAsymmetricRelationshipOperation(IndexWord start, IndexWord end) throws JWNLException, CloneNotSupportedException {
        ...
        System.out.println("******* THAT'S ME, MARIO *******");
        ...
        int lcs = ((AsymmetricRelationship) list.get(0)).getCommonParentIndex();
        System.out.println(list.get(0).getNodeList().get(lcs).getSynset());
